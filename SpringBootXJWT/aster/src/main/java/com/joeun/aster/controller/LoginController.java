package com.joeun.aster.controller;

import org.springframework.web.bind.annotation.RestController;

import com.joeun.aster.constants.SecurityConstants;
import com.joeun.aster.domain.AuthenticationRequest;
import com.joeun.aster.prop.JwtProp;
...
public class LoginController {
    ...
    private byte[] signingKey = jwtProp.getSecretKey().getBytes();
    // 토큰 생성
    /// login
    // - username
    // - password
    ...
    public ResponseEntity<?> login(@RequestBody AuthenticationRequest request) {
        ...
        String jwt = Jwts.builder()
                ...
                .claim("uid", username) // Payload : uid : username
